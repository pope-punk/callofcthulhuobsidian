...
## Content (Example Sequence - Needs Finalization based on Rules)

**(GM Note: This is the KNOWN OUTPUT sequence. It must be derivable from a unique 4-digit code using the finalized [[SDEC Randomizer Mapping Rules]].)**

**Axon & Dendrite - FINAL BROADCAST (Unaired) - Segment Order**

1.  **Segment 3:** (Music Block / Weird Transmission)
2.  **Segment 1:** (Opening Monologue / Soundscape)
3.  **Segment 6:** (Closing Remarks / Cryptic Sign-off)
4.  **Segment 2:** (Call-in Segment A)
5.  **Segment 4:** (Interview / Feature)
6.  **Segment 5:** (Call-in Segment B / Listener Mail)
