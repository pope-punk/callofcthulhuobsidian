**Tags:** #Item #Document #Clue #Lore #G6 #MacGuffin
...
* The specific insights into Algorithm/DNA interaction needed by Syd to synthesize G6.

## Significance
* The combination of notes + reagent is the scientific key required to create [[G6 (Non-Gallium Antidote)|G6]].
* Required to cure [[Alice Redmond (Agent Altissimo)]] (and so, indirectly, to gain access to the decrypted contents of Blanc's hard drive — the only viable path into PCBOT and onward to SDEC).
* Confirms the link between the Foxglove Algorithm, advanced biotech, and the potential for chemical countermeasures/enhancements.

## Location & Status (Oct 1997)
* Secured in the safe at the [[Oliver Foxglove House]]. Accessible only after solving the [[Safe Puzzle]]. Retrieving the notes and reagent is the reward for solving the puzzle and a precondition for synthesizing G6.
